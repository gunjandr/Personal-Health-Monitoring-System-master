...
public class ViewProfileActivity extends Activity {
    private EditText firstname,lastname,age,weight,hight,blood,doctor,EmerName,EmerContact,phonenumber,emailemer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        emailemer=(EditText)findViewById(R.id.emergencyEmail);//.emergencyEmail);
        //get current user
        ...
        if (user != null) {
            ...
            databaseReference.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    String emailemere = (String)dataSnapshot.child("emailemer").getValue();
                    ...
                    if(emailemere != null){emailemer.setText(emailemere.toString());}
    ...
    private void submitUser(){
        ...
        String Emailemer = emailemer.getText().toString().trim();
        ...
        if (user != null) {
            ...
            taskMap.put("emailemer",Emailemer);
